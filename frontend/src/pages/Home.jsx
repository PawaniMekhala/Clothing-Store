        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <div className="flex space-x-4">
              <Link to="/products/Men" className="btn-primary bg-white text-primary-600 hover:bg-gray-100">
                Shop Men
              </Link>
              <Link to="/products/Women" className="btn-secondary bg-transparent border-2 border-white hover:bg-white hover:text-primary-600">
                Shop Women
              </Link>
            </div>
          </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Link to="/products/Men" className="card overflow-hidden group cursor-pointer">
            ...
            <Link to="/products/Women" className="card overflow-hidden group cursor-pointer">
              <div className="relative h-64 overflow-hidden">
                <img
            ...
            <Link to="/products/Kids" className="card overflow-hidden group cursor-pointer">
              <div className="relative h-64 overflow-hidden">
                <img
